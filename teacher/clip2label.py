...
if __name__ == "__main__":
    ...
    dir1 = os.listdir('./data/tvsum/vid_slowfast')
    dir2 = os.listdir('./data/tvsum/vid_clip')
    ...
    save_dir = f'./data/tvsum/txt_clip/_xMr-HKMfVA.npz'
    ...
    for vid in tqdm.tqdm(dir):
        vid_path = os.path.join(f'./data/tvsum/vid_clip', vid)
