...
with gr.Blocks(css=css) as demo:
    ...
    with gr.Column(elem_id="col-container"):
        gr.Markdown("""## 🤖️ Detecting Moments and Highlights in Videos via Natural Language Queries using Cross-Attention Transformer 
                    Given a video and text query, return relevant window and highlight.
                    Hitesh Kumar M.Tech NIT Kurukshetra (32213115) 2022 -2024""",
                    elem_id="header")
