...
def plot_hl(pred_json, save_dir_i,  base_json=None):
    ...
    if not base_json:
        ...
        plt.plot(x, pred_saliency, label='VTG using CAT\'s Prediction', color=color2_dark, linewidth=6, linestyle='solid')
        ...
        plt.plot(x, gt_saliency, label='GT Saliency', color=color1_dark, linewidth=6, linestyle='solid')
        plt.plot(x, pred_saliency, label='VTG\'s Prediction', color=color2_dark, linewidth=6, linestyle='solid')
...
if __name__ == "__main__":
    ...
    for domain in [ "BT"]:
    # domain = 'BK'
        pred_json_val = load_jsonl(f"/mnt/d/UniVTG-main/UniVTG-main/plot/tvsum/{domain}.jsonl")
        
        # other settings
        template_path = "/mnt/d/UniVTG-main/UniVTG-main/plot/settings/template.png"
        color1 = '#90ee90'  # green
        color2 = '#add8e6'  # blue
        ...
        font_path1 = "/mnt/d/UniVTG-main/UniVTG-main/plot/settings/calibri.ttf"
        font_path2 = "/mnt/d/UniVTG-main/UniVTG-main/plot/settings/calibri-bold.ttf"
        font_path3 = "/mnt/d/UniVTG-main/UniVTG-main/plot/settings/calibri-italy.ttf"
        ...
        save_dir = os.path.join(os.path.join('/mnt/d/UniVTG-main/UniVTG-main/plot', 'tvsum', domain))
        print(save_dir)
