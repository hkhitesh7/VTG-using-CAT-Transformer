...
if __name__ == "__main__":
    ...
    for domain in ["dog"]:
        video_path= os.path.join("/mnt/d/UniVTG-main/UniVTG-main/examples/", domain)

        pred_json_val = load_jsonl(f"/mnt/d/UniVTG-main/UniVTG-main/plot/youtube/{domain}.jsonl")
        ...
        save_dir = os.path.join(os.path.join('/mnt/d/UniVTG-main/UniVTG-main/plot', 'youtube', domain))
