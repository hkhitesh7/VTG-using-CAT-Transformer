...
train_path+=(data/qvhighlights/qvhighlights_train.jsonl)

#eval_path=data/qvhighlights/metadata/qvhighlights_val.jsonl
eval_path=data/qvhighlights/qvhighlights_val.jsonl
eval_split_name=val
...
python -m torch.distributed.launch --nproc_per_node=8 --max_restarts=0 --rdzv_backend=c10d --rdzv_endpoint=localhost:0 ./main/train_vlp_ddp.py \
--dset_type ${dset_type}    \
--dset_name ${dset_name}    \
